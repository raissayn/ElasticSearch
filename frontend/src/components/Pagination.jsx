const Pagination = ({ currentPage, totalPages, onPageChange }) => {
  ...
  const baseButton = 'px-3 py-2 rounded-full text-sm font-bold border transition-colors';
  const activeButton = 'bg-primary text-white border-primary';
  const inactiveButton = 'bg-white text-gray-700 border-gray-300 hover:border-gray-400';
  const navButton =
